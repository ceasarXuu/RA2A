...
当前状态：**Phase 0 feasibility validation**。产品准入规则已经确认；[V1-V4 macOS 首轮实验](./experiments/codex-cli-v1-v4.md)已完成，direct resume 因活跃 writer 冲突被排除，单 App Server + remote TUI 路线首轮通过。V5/V6、三平台和 PD31 交叉矩阵完成前不进入主体架构重构。
